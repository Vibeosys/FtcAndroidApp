...
public class SqlContract {
    ...
    public abstract class SqlPageType {
        public static final String TABLE_NAME = "page_type";
    ...
    public abstract class SqlPage {
        ...
        public static final String PAGE_TYPE_ID = "PageTypeId";
        public static final String PAGE_CREATED_DATE = "CreatedDate";
        public static final String PAGE_UPDATED_DATE = "UpdatedDate";
        public static final String ACTIVE = "Active";
    }
    ...
    public abstract class SqlWidget {
        ...
        public static final String WIDGET_DATE = "WidgetData";
        public static final String WIDGET_CREATED_DATE = "CreatedDate";
        public static final String WIDGET_UPDATED_DATE = "UpdatedDate";
        public static final String ACTIVE = "Active";
    }
}
